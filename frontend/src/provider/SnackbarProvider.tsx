...
export function SnackbarProvider({ children }: PropsWithChildren<any>) {
  ...
  const openSnackbar = useCallback((msg: string, severity: SnackbarSeverity = 'success') => {
...
export function useSnackbarContext() {
  ...
  if (!ctx) throw new Error('useSnackbarContext must be used within a SnackbarProvider');
  return ctx;
}
