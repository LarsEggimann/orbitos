...
from src.modules.electrometer.models import ElectrometerSettings, ElectrometerData, ElectrometerSourceVoltageData
...
def init_db() -> None:
    tables = [
        ...
        SQLModel.metadata.tables[ElectrometerSourceVoltageData.__tablename__],
    ]
